...
export function ImportModal({ dataType, onImport, onClose }: ImportModalProps) {
  ...
  const getSampleData = () => {
    switch (dataType) {
      ...
      case 'locations':
        return [
          { name: "Main Warehouse", duration: 8, vehicles: 5, gps_devices: 3, fuel_sensors: 2 },
          { name: "Distribution Center", duration: 6, vehicles: 3, gps_devices: 2, fuel_sensors: 1 }
        ];
